export const about = {
  ...
  article: {
    topic_1: {
      ...
      paragraph_1: 'Olá, 👋!',
      paragraph_2:
        'Sou <strong>Lucas Josino</strong>, um <strong>Brasileiro 🇧🇷</strong> de 21 anos e um entusiasta <strong>Desenvolvedor Backend</strong>. Atualmente, estou cursando um <strong>Bacharelado em Sistemas de Informação</strong>.',
      paragraph_3:
